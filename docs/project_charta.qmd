...
**Abgedeckter Zeitraum:** Einzelflug- und LTDB-Daten stehen für 2020–2024 zur Verfügung. 2019 wird in den RUMBA-Berichten als Vor-Corona-Referenzjahr geführt und dient als Basis für Trend und Zielpfad.
...
2. Wie haben sich die THG-Emissionen der Bundeskanzleisflüge seit 2019 (Vor-Corona-Referenz; Datenjahre 2020–2024) entwickelt und ist die Bundesverwaltung auf Kurs zur Erreichung des Reduktionsziels (–30% bis 2030)?
...
- RUMBA – Umweltberichte 2021–2024, GS-UVEK, mit THG-Emissionen Flugreisen je Berichtsjahr (Datenjahre 2020–2023; 2019 als Vor-Corona-Referenzjahr)
...
2. **Klimaimpact kommunizieren:** Die CO₂-Emissionen der Bundesratsflüge verständlich einordnen und im Zeitverlauf (Datenjahre 2020–2024; 2019 als Vor-Corona-Referenz aus RUMBA) sowie im Vergleich zu anderen Emissionsquellen der Bundesverwaltung darstellen.
3. **Zielfortschritt aufzeigen:** Den Fortschritt gegenüber dem Aktionsplan Flugreisen (–30% bis 2030 gegenüber 2019, Vor-Corona-Referenzjahr) visualisieren.
...
| Vollständigkeit | Alle 5 Datenjahre (2020–2024) dargestellt; 2019 als Vor-Corona-Referenz klar markiert | 100% der verfügbaren Flugdaten integriert |
...
:::
**Profil:** Lehrerin, politisch interessiert, liest regelmässig Tamedia-Medien und SRF-Online. Keine Fachkenntnisse in der Datenanalyse. Nutzt Smartphone und Laptop gleichermassen.
...
| RUMBA Umweltberichte 2021–2024 | THG-Emissionen Bundesverwaltung gesamt und nach Kategorie inkl. Flugreisen. BR-Jets/Helikopter separat | PDF (Diagramme) | 2020–2023; 2019 als Vor-Corona-Referenz | Aggregierte Jahreswerte. Keine Einzelflug-Emissionen. 2024er Daten noch nicht publiziert |
...
| Datenlücken vor 2020 (keine Einzelflug-Excel-Daten) | Gering | Gering | Flugdaten 2020 vorhanden (Excel). RUMBA-Zeitreihe ergänzt Trend ab 2019 (Vor-Corona-Referenz) |
...
- *Interaktivität:* RUMBA-Berichtsjahr (publizierte Jahre 2020–2023) per `st.radio`. Alle Kennzahlen in den Kacheln aktualisieren sich gemeinsam.
...
- *Visualisierung:* Liniendiagramm der Flugemissionen im Zeitfenster 2019–2024 mit Zielpfad (–30 % bis 2030, Aktionsplan Flugreisen). 2019 wird als Vor-Corona-Referenzjahr aus RUMBA gekennzeichnet; Einzelflugdaten stehen ab 2020 zur Verfügung. 2020 wird als COVID-Sondereffekt markiert.
...
- *Annotation:* 2019-Basisjahr (20'200 t, Vor-Corona-Referenz; abgeleitet aus RUMBA 2024), «auf Zielkurs»-Status (RUMBA 2025).
...
| Liniendiagramm + Zielpfad | Emissionstrend 2019–2024 (2019 Referenz; Einzelflugdaten ab 2020) (Kap. 3) | Zeitlicher Verlauf und Zielfortschritt |
...
| Betreuung / Auftraggeber | M. Dömer | Fachliche Begleitung, Feedback, Abnahme Meilensteine | doem@zhaw.ch |
