...
::: {#fig-elephant}
![](pics/Gemini_Persona.png)

Bild 1: Mit Nano Banana von Gemini erstelltes Persona-Porträt. 
:::
...
::: {#fig-elephant}
![](pics/Gemini_AntiPersona.png)

Bild 2: Mit Nano Banana von Gemini erstelltes Anti-Persona-Porträt. 
:::
...
::: {#fig-elephant}
![](pics/Gemini_NonHumanPersona.png)

Bild 3: Mit Nano Banana von Gemini erstelltes Non-Human-Persona Bild. 
:::
...
- *Visualisierung:* Interaktiver 3-D-Globus (eigenes WebGL-Modul, `app/lib/globe.py`) mit den Top-Routen ab Schweizer Flughäfen; daneben ein Big-Number-Tile mit der berechneten Jahresmenge CO₂eq und einer dazu gestellten Vergleichszahl aus dem offiziellen RUMBA-Bericht (Tooltip erklärt die Methodendiskrepanz).
...
- *Wert:* Sofortige Orientierung; ehrliche Einordnung der Methodendifferenz zwischen berechneten Werten und offiziellem RUMBA-Total.
...
- *Visualisierung:* Interaktiver 3-D-Globus (eigenes WebGL-Modul, `app/lib/globe.py`) mit Flugverbindungen ab Schweizer Flughäfen; Plotly-Arc-Map (Scattergeo) als Fallback, falls die Globus-Daten leer sind. Ergänzt durch eine durchsuchbare Tabelle der Einzelflüge.
