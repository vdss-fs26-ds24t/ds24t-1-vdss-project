...
- *Visualisierung:* Interaktive Arc-Map (Plotly Scattergeo) mit Flugverbindungen ab Schweizer Flughäfen, filterbar nach Jahr und Departement. Ergänzt durch eine durchsuchbare Tabelle der Einzelflüge.
- *Narrativ:* «Welche Destinationen wurden am häufigsten angeflogen?»
- *Interaktivität:* Filter nach Jahr (2021, 2022, 2023, 2024), Dropdown nach Departement. Hinweis: Einzelnamen sind in den veröffentlichten RUMBA-Flugdaten nicht enthalten.
...
- *Visualisierung:* Linien-/Flächendiagramm der offiziellen RUMBA-Flugemissionen (2019–2023) mit Zielpfad (–30% bis 2030, Aktionsplan Flugreisen). 2020 wird als isolierter Punkt dargestellt (COVID, nicht repräsentativ). 2024 wird als Diamond-Marker «berechnet» ergänzt.
- *Annotation:* 2019-Basisjahr (20'200 t, abgeleitet aus RUMBA 2024), «auf Zielkurs»-Status (RUMBA Umweltbericht 2024, Kap. 4.2).
- *Narrativ:* «Ist die Bundesverwaltung auf Kurs?»
- *Wert:* Offizielle Zeitreihe und Zielfortschritt auf einen Blick; differenzierte Botschaft: Linienflüge auf Kurs, BR-Jets +39% seit 2019 (kognitiv-analytisch und kommunikativ).

**Kapitel 4 – Im Vergleich: Vereinigtes Königreich**
- *Visualisierung:* Dot-Plot (Dumbbell-Stil) mit CH Bundesverwaltung vs. UK Central Government (Greening Government Commitments Report).
...
| Liniendiagramm + Zielpfad | Emissionstrend 2019–2023 RUMBA + 2024 berechnet (Kap. 3) | Zeitlicher Verlauf und Zielfortschritt |
...
| Dot-Plot (Dumbbell) | CH vs. UK Institutionenvergleich (Kap. 4) | Direkter Vergleich diskreter Kategorien |
...
- Filterpanel (Jahr, Departement) für Karte und Tabelle
